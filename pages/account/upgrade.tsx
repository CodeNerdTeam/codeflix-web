...
function upgrade() {
  ...
  return (
    <div className="bg-slate-100">
      ...
      <div className="border-b-[1px] border-solid shadow-sm">
        <div className="ml-7 -mb-1 w-[150px]">
          <a href="/home">
            <img src="/logo_codeflix.png" alt="" height={150} width={150} />
          </a>
        </div>
      </div>
      <div className="min-h-[139px] mt-1">
        <div>
                          ...
                          <div className="min-h-[70px] flex items-center">
                            <div className="py-[11px] pr-[62px] pl-[72px] w-full">
                              ...
                              <p className="text-xs text-black font-normal font-sans text-left mt-[6px] tracking-wider m-0">
                                ...
                                for 6 months and a 40.000 VND discount when
                                buying a package with a Vietcombank
                                International card. Apply to the first 300
                                accounts.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="min-h-[70px] flex items-center">
                            <div className="py-[11px] pr-[62px] pl-[72px] w-full">
                              ...
                              <p className="text-xs text-black font-normal font-sans text-left mt-[6px] tracking-wider m-0">
                                ...
                                ZaloPay account for the first time linking
                                payment to buy service packages on Codeflix.
                              </p>
                            </div>
                          </div>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="text-right text-black font-medium font-sans text-sm">
                              <span className="text-[#ff6500]">66.000 VND</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div className="bg-[#fcfbfb] rounded-xl shadow-[0px_4px_4px_rgb(0_0_0_/_25%)] py-5 px-7 mb-6">
                    ...
                    <div className="my-8">
                      <p className="text-sm tracking-normal font-sans text-black">
                        ...
                        Service, and the right to allow Codeflix to
